...
export default class basicLogger extends Readable {
    ...
    addLog(message:string, level:logLevel, sender = this.defaultSender) {
        ...
        switch (level) {
            case logLevel.trace:
                string = (this.colors ? colors.fg.gray : "") + "[trace] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
                ...
                break;
            case logLevel.debug:
                string = "[debug] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
                ...
                break;
            case logLevel.info:
                string = (this.colors ? colors.fg.cyan : "") + "[info] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
                ...
                break;
            case logLevel.warn:
                string = (this.colors ? colors.fg.yellow : "") + "[warn] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
                ...
                break;
            case logLevel.error:
                string = (this.colors ? colors.fg.red : "") + "[error] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
                ...
                break;
            case logLevel.fatal:
                string = (this.colors ? colors.bg.red : "") + "[fatal] " + "[" + new Date().toString() + "] " + sender + ": " + message + (this.colors ? colors.reset : "") + "\n"
